...
int main(int argc, char *argv[]) {
    ...
    std::string output_triangles_filename = "../data/" + dataset + "/cache/" + dataset + "_triangles.txt";
    std::string output_quadrangles_filename = "../data/" + dataset + "/cache/" + dataset + "_quadrangles.txt";
