...
from utils import retrieve_all_paths_with_mp, retrieve_paths, get_path_dict_and_length, one_hot_path_id, sample_paths
...
def load_data(model_args):
    ...
    if args.use_analogy:
        ...
        if args.use_sample:
            ...
            print('=== TRANSFORMING PATH TO ONE-HOT IDs ===')
